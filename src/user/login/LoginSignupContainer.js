...
class LoginSignupContainer extends React.Component {
  ...
  render () {
    return (
      <div>
        {/*<body className={'body-login-signup'}>*/}
            ...
            <div className="form-container sign-up-container">
              <form action="#">
                ...
                <div className="social-container">
                  <a href="#" className="social fab facebook-icon"/>
                  <a href="#" className="social fab google-icon"/>
                  <a href="#" className="social fab github-icon"/>
                </div>
